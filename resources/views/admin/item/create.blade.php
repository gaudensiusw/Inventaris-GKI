    ...
    <form action="{{ route('admin.item.store') }}" method="POST" enctype="multipart/form-data" id="itemForm">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Contoh: Proyektor Epson EB-X41"
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="unit" class="form-control">
                        ...
                        <option value="buku" {{ old('unit') == 'buku' ? 'selected' : '' }}>Buku</option>
        ...
        <div class="form-section">
            ...
            <p style="font-size:12px;color:#64748b;margin-bottom:12px;">Distribusi barang berdasarkan kondisi fisik. Total
                harus sama dengan jumlah barang.</p>

            <div class="form-row-3">
                <div class="form-group">
                    <label>Baik</label>
                    <input type="number" name="qty_baik" class="form-control condition-input"
                        value="{{ old('qty_baik', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Rusak Ringan</label>
                    <input type="number" name="qty_rusak_ringan" class="form-control condition-input"
                        value="{{ old('qty_rusak_ringan', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Rusak Berat</label>
                    <input type="number" name="qty_rusak_berat" class="form-control condition-input"
                        value="{{ old('qty_rusak_berat', 0) }}" min="0">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <p style="font-size:12px;color:#64748b;margin-bottom:12px;">Distribusi barang berdasarkan status operasional.
                Total harus sama dengan jumlah barang.</p>

            <div class="form-row-3">
                <div class="form-group">
                    <label>Tersedia</label>
                    <input type="number" name="qty_tersedia" class="form-control status-input"
                        value="{{ old('qty_tersedia', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Dipinjam</label>
                    <input type="number" name="qty_dipinjam" class="form-control status-input"
                        value="{{ old('qty_dipinjam', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Sedang Diperbaiki</label>
                    <input type="number" name="qty_diperbaiki" class="form-control status-input"
                        value="{{ old('qty_diperbaiki', 0) }}" min="0">
                </div>
            </div>
            <div class="form-row-3">
                <div class="form-group">
                    <label>Hilang</label>
                    <input type="number" name="qty_hilang" class="form-control status-input"
                        value="{{ old('qty_hilang', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Tidak Digunakan</label>
                    <input type="number" name="qty_tidak_digunakan" class="form-control status-input"
                        value="{{ old('qty_tidak_digunakan', 0) }}" min="0">
                </div>
                <div class="form-group">
                    <label>Dalam Pengadaan</label>
                    <input type="number" name="qty_pengadaan" class="form-control status-input"
                        value="{{ old('qty_pengadaan', 0) }}" min="0">
                </div>
            </div>

            <div class="form-tip">
                💡 Tip: Isi status lainnya terlebih dahulu, lalu klik tombol ini untuk mengisi "Tersedia" secara otomatis.
                <button type="button" class="btn btn-primary btn-sm" onclick="autoFillTersedia()"
                    style="margin-left:auto;">Auto Isi Tersedia</button>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                <textarea name="description" class="form-control"
                    placeholder="Tambahkan catatan atau deskripsi tambahan...">{{ old('description') }}</textarea>
            </div>
        </div>
