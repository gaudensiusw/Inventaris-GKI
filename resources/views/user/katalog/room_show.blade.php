...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-3xl p-5 shadow-sm border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all group flex flex-col justify-between">
            <div>
                <!-- Image Container -->
                <a href="{{ route('user.katalog.show', $item->id) }}" class="block relative w-full h-40 bg-slate-100 rounded-2xl overflow-hidden mb-4 border border-slate-50 flex items-center justify-center">
                ...
                <a href="{{ route('user.katalog.show', $item->id) }}" class="block hover:text-blue-600 transition-colors">
                    <h3 class="text-sm font-black text-slate-800 leading-tight mb-1">
                        {{ $item->name }}
                    </h3>
                </a>
